...
{
    /// <summary>
    /// cjplpback:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class cjplpback
    {
        ...
        {
            set { _inlet_type = value; }
            get { return _inlet_type; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public string Flap_Material
        {
            set { _flap_material = value; }
            get { return _flap_material; }
        }
        /// <summary>
        /// 
        /// </summary>
