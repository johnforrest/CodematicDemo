...
namespace Maticsoft.DAL
{
    ...
    public partial class ps_valve
    {
        ...
        public bool Exists(string Exp_No)
        {
            ...
            strSql.Append("select count(1) from ps_valve");
        ...
        public bool Add(Maticsoft.Model.ps_valve model)
        {
            ...
            MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@Valve_Type", MySqlDbType.VarChar,50),
                    new MySqlParameter("@Manufacturer", MySqlDbType.VarChar,50),
                    new MySqlParameter("@ValveModel", MySqlDbType.VarChar,50),
                    new MySqlParameter("@Code", MySqlDbType.VarChar,10),
                    new MySqlParameter("@Model", MySqlDbType.VarChar,10),
            ...
            parameters[10].Value = model.Valve_Type;
            parameters[11].Value = model.Manufacturer;
            parameters[12].Value = model.ValveModel;
            parameters[13].Value = model.Code;
            parameters[14].Value = model.Model;
            parameters[15].Value = model.Address;
            parameters[16].Value = model.PointPosition;
            parameters[17].Value = model.DataSource;
            parameters[18].Value = model.Visibility;
            parameters[19].Value = model.Sunit;
            parameters[20].Value = model.Sdate;
            parameters[21].Value = model.UpdateTime;
            parameters[22].Value = model.Mdate;
            parameters[23].Value = model.Status;
            parameters[24].Value = model.DataListID;
            parameters[25].Value = model.Ename;
            parameters[26].Value = model.Design_Dept;
            parameters[27].Value = model.Conster_Dept;
            parameters[28].Value = model.Belong;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ps_valve set ");
            ...
            strSql.Append("Valve_Type=@Valve_Type,");
            strSql.Append("Manufacturer=@Manufacturer,");
            strSql.Append("ValveModel=@ValveModel,");
            ...
            parameters[9].Value = model.Valve_Type;
            parameters[10].Value = model.Manufacturer;
            parameters[11].Value = model.ValveModel;
            ...
            parameters[23].Value = model.DataListID;
        ...
        public bool Delete(string Exp_No)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ps_valve ");
            strSql.Append(" where Exp_No=@Exp_No ");
            MySqlParameter[] parameters = {
                    new MySqlParameter("@Exp_No", MySqlDbType.VarChar,100)          };
            parameters[0].Value = Exp_No;
        ...
        public Maticsoft.Model.ps_valve GetModel(string Exp_No)
        {
            ...
            Maticsoft.Model.ps_valve model = new Maticsoft.Model.ps_valve();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.ps_valve DataRowToModel(DataRow row)
        {
            Maticsoft.Model.ps_valve model = new Maticsoft.Model.ps_valve();
            if (row != null)
            {
                ...
                if (row["Valve_Type"] != null)
                {
                    model.Valve_Type = row["Valve_Type"].ToString();
                }
                if (row["Manufacturer"] != null)
                {
                    model.Manufacturer = row["Manufacturer"].ToString();
                }
                if (row["ValveModel"] != null)
                {
                    model.ValveModel = row["ValveModel"].ToString();
                }
                if (row["Code"] != null)
                {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from ps_valve T ");
