...
namespace Maticsoft.DAL
{
	...
	public partial class ps_weir
	{
		...
		public bool Add(Maticsoft.Model.ps_weir model)
		{
			...
			strSql.Append("Prj_No,Prj_Name,Exp_No,MapCode,SewageSystem_ID,StormSystem_ID,Type,X,Y,High,Top_Ele,Bot_Ele,Width,Code,Address,PointPosition,DataSource,Visibility,Sunit,Sdate,UpdateTime,Mdate,DataListID,Status,Ename,Design_Dept,Conster_Dept,Belong,Operator,Note,Exp_NoOri,filename,update)");
		...
		public bool Update(Maticsoft.Model.ps_weir model)
		{
			...
			parameters[31].Value = model.update;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Prj_No,Prj_Name,Exp_No,MapCode,SewageSystem_ID,StormSystem_ID,Type,X,Y,High,Top_Ele,Bot_Ele,Width,Code,Address,PointPosition,DataSource,Visibility,Sunit,Sdate,UpdateTime,Mdate,DataListID,Status,Ename,Design_Dept,Conster_Dept,Belong,Operator,Note,Exp_NoOri,filename,update ");
