...
namespace Maticsoft.DAL
{
    ...
    public partial class cjplpback
    {
        ...
        public bool Exists(string Exp_NoOri)
        {
            ...
            strSql.Append("select count(1) from cjplpback");
        ...
        public bool Delete(string Exp_NoOri)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from cjplpback ");
            strSql.Append(" where Exp_NoOri=@Exp_NoOri ");
            MySqlParameter[] parameters = {
                    new MySqlParameter("@Exp_NoOri", MySqlDbType.VarChar,255)           };
            parameters[0].Value = Exp_NoOri;
        ...
        public bool DeleteList(string Exp_NoOrilist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from cjplpback ");
            strSql.Append(" where Exp_NoOri in (" + Exp_NoOrilist + ")  ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from cjplpback T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "cjplpback";
			parameters[1].Value = "Exp_NoOri";
