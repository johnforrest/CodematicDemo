...
namespace Maticsoft.DAL
{
    ...
    public partial class exportinfo
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from exportinfo");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update exportinfo set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from exportinfo ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = {
                    new MySqlParameter("@id", MySqlDbType.Int32)
            };
        ...
        public Maticsoft.Model.exportinfo GetModel(int id)
        {
            ...
            Maticsoft.Model.exportinfo model = new Maticsoft.Model.exportinfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.exportinfo DataRowToModel(DataRow row)
        {
            Maticsoft.Model.exportinfo model = new Maticsoft.Model.exportinfo();
            if (row != null)
            {
                ...
                if (row["Basin"] != null)
                {
                    model.Basin = row["Basin"].ToString();
                }
                if (row["Strname"] != null)
                {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from exportinfo T ");
