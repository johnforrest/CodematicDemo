<%@ Page Title="ps_gate" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.ps_gate.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Top_Ele" HeaderText="Top_Ele" SortExpression="Top_Ele" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Bot_Ele" HeaderText="Bot_Ele" SortExpression="Bot_Ele" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="GateModel" HeaderText="GateModel" SortExpression="GateModel" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Num" HeaderText="Num" SortExpression="Num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Control_Type" HeaderText="Control_Type" SortExpression="Control_Type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Switch_Style" HeaderText="Switch_Style" SortExpression="Switch_Style" ItemStyle-HorizontalAlign="Center"  /> 
