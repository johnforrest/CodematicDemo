<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Maticsoft.Web.ps_pumpstation.Show" Title="显示页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblService_Dis" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Service_Area
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblService_Area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		SewageSystem_ID
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblPS_Category2" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Ps_Num
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblDesign_Storm" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Design_Sewer
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblDesign_Sewer" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Cur_Strom
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblCur_Strom" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Cur_Sew
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblCur_Sew" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Min_Level
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblControl_Level" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Warnning_Level
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblWarnning_Level" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		S_Invert
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblS_Invert" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		PSize
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblOverOutfallID" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Tel
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblForebayLen" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ForebayWid
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblForebayWid" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ForebayDep
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblForebayDep" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Code
