<%@ Page Title="ps_pumpstation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.ps_pumpstation.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Service_Dis" HeaderText="Service_Dis" SortExpression="Service_Dis" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Service_Area" HeaderText="Service_Area" SortExpression="Service_Area" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="PS_Category2" HeaderText="PS_Category2" SortExpression="PS_Category2" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Ps_Num" HeaderText="Ps_Num" SortExpression="Ps_Num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Design_Storm" HeaderText="Design_Storm" SortExpression="Design_Storm" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Design_Sewer" HeaderText="Design_Sewer" SortExpression="Design_Sewer" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Cur_Strom" HeaderText="Cur_Strom" SortExpression="Cur_Strom" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Cur_Sew" HeaderText="Cur_Sew" SortExpression="Cur_Sew" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Min_Level" HeaderText="Min_Level" SortExpression="Min_Level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Control_Level" HeaderText="Control_Level" SortExpression="Control_Level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Warnning_Level" HeaderText="Warnning_Level" SortExpression="Warnning_Level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="S_Invert" HeaderText="S_Invert" SortExpression="S_Invert" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PSize" HeaderText="PSize" SortExpression="PSize" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="OverOutfallID" HeaderText="OverOutfallID" SortExpression="OverOutfallID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Tel" HeaderText="Tel" SortExpression="Tel" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ForebayLen" HeaderText="ForebayLen" SortExpression="ForebayLen" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ForebayWid" HeaderText="ForebayWid" SortExpression="ForebayWid" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ForebayDep" HeaderText="ForebayDep" SortExpression="ForebayDep" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="DataListID" HeaderText="DataListID" SortExpression="DataListID" ItemStyle-HorizontalAlign="Center"  /> 
