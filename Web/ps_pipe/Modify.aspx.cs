...
namespace Maticsoft.Web.ps_pipe
{
	...
	private void ShowInfo(string Lno)
	{
		...
		this.txtS_Point.Text=model.S_Point;
		this.txtS_Deep.Text=model.S_Deep.ToString();
		this.txtIn_Elev.Text=model.In_Elev.ToString();
		this.txtE_Point.Text=model.E_Point;
		this.txtE_Deep.Text=model.E_Deep.ToString();
		this.txtOut_Elev.Text=model.Out_Elev.ToString();
		...
		this.txtServiceLife.Text=model.ServiceLife;
		this.txtShapeType.Text=model.ShapeType;
		this.txtPSize.Text=model.PSize;
		this.txtPipeLength.Text=model.PipeLength.ToString();
		this.txtFlowDir.Text=model.FlowDir;
		this.txtEmBed.Text=model.EmBed;
		this.txtInterface.Text=model.Interface;
		...
		this.txtExp_No0.Text=model.Exp_No0;
		this.txtExp_No1.Text=model.Exp_No1;
