<%@ Page Title="ps_point" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.ps_point.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Point_Type" HeaderText="Point_Type" SortExpression="Point_Type" ItemStyle-HorizontalAlign="Center"  /> 
