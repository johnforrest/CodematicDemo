...
namespace Maticsoft.Web.ps_point
{
	...
	{
		Maticsoft.BLL.ps_point bll=new Maticsoft.BLL.ps_point();
		Maticsoft.Model.ps_point model=bll.GetModel(Exp_No);
		...
		this.txtPoint_Type.Text=model.Point_Type;
		...
		public void btnSave_Click(object sender, EventArgs e)
		{
			...
			if(this.txtPoint_Type.Text.Trim().Length==0)
			{
				strErr+="Point_Type不能为空！\\n";	
			}
			...
			string Point_Type=this.txtPoint_Type.Text;
