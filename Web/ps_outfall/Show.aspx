<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Maticsoft.Web.ps_outfall.Show" Title="显示页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblBottom_Elev" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		OutfallShape
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblOutfallShape" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		OutfallType
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblRotation" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Code
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblFlap_Materail" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Receive
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblReceive" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Address
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblOutfall_Type" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Status
