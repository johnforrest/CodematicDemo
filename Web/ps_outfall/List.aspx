<%@ Page Title="ps_outfall" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.ps_outfall.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Bottom_Elev" HeaderText="Bottom_Elev" SortExpression="Bottom_Elev" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="OutfallShape" HeaderText="OutfallShape" SortExpression="OutfallShape" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Flap_Materail" HeaderText="Flap_Materail" SortExpression="Flap_Materail" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Receive" HeaderText="Receive" SortExpression="Receive" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Outfall_Type" HeaderText="Outfall_Type" SortExpression="Outfall_Type" ItemStyle-HorizontalAlign="Center"  /> 
