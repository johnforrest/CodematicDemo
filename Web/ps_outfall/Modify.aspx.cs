...
namespace Maticsoft.Web.ps_outfall
{
	...
	private void ShowInfo(string Exp_No)
	{
		...
		this.txtBottom_Elev.Text=model.Bottom_Elev.ToString();
		this.txtOutfallShape.Text=model.OutfallShape;
		...
		this.txtFlap_Materail.Text=model.Flap_Materail;
		this.txtReceive.Text=model.Receive;
		...
		this.txtOutfall_Type.Text=model.Outfall_Type;
