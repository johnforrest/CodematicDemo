<%@ Page Title="ps_valve" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.ps_valve.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Valve_Type" HeaderText="Valve_Type" SortExpression="Valve_Type" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="ValveModel" HeaderText="ValveModel" SortExpression="ValveModel" ItemStyle-HorizontalAlign="Center"  /> 
