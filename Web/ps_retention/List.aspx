<%@ Page Title="ps_retention" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.ps_retention.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Inflow_Type" HeaderText="Inflow_Type" SortExpression="Inflow_Type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Outflow_Type" HeaderText="Outflow_Type" SortExpression="Outflow_Type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Total_Vol" HeaderText="Total_Vol" SortExpression="Total_Vol" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="B_Level" HeaderText="B_Level" SortExpression="B_Level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Max_Level" HeaderText="Max_Level" SortExpression="Max_Level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Min_Level" HeaderText="Min_Level" SortExpression="Min_Level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Design_Time" HeaderText="Design_Time" SortExpression="Design_Time" ItemStyle-HorizontalAlign="Center"  /> 
