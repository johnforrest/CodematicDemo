<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Maticsoft.Web.ps_retention.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtInflow_Type" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Outflow_Type
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtOutflow_Type" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Total_Vol
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtTotal_Vol" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		B_Level
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtB_Level" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Max_Level
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtMax_Level" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Min_Level
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtDesign_Time" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Ps_Num
