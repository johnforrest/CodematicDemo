<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Maticsoft.Web.ps_wwtp.Show" Title="显示页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblWWTPType" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Ps_Num
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblTreatment_Level" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblTreatment_Technology" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ReceiveWater
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblDesign_Capa" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		SludgeDesign_Capa
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblSludgeDesign_Capa" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Code
