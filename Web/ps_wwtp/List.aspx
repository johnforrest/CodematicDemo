<%@ Page Title="ps_wwtp" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.ps_wwtp.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="WWTPType" HeaderText="WWTPType" SortExpression="WWTPType" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Ps_Num" HeaderText="Ps_Num" SortExpression="Ps_Num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Treatment_Level" HeaderText="Treatment_Level" SortExpression="Treatment_Level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Treatment_Technology" HeaderText="Treatment_Technology" SortExpression="Treatment_Technology" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Design_Capa" HeaderText="Design_Capa" SortExpression="Design_Capa" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="SludgeDesign_Capa" HeaderText="SludgeDesign_Capa" SortExpression="SludgeDesign_Capa" ItemStyle-HorizontalAlign="Center"  /> 
